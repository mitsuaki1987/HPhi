...
*  ``J2'x``, ``J2'y``, ``J2'z``, ``J2'xy``, ``J2'yx``, ``J2'xz``,
   ...
   **説明 :** 梯子格子でのスピン相互作用 (:numref:`fig_ladder` 参照)
   ...
   ``J0``\ を指定した上で\ ``J0x, J0y, J0z``\ 等も指定した場合は\ HPhi++\ を終了します。
...
*  ``t``, ``t0``, ``t1``, ``t2``
   ...
   **説明 :**
   ...
   ``t``\ と\ ``t0``\ 等の両方が指定された場合には\ HPhi++\ を終了します。
...
*  ``V``, ``V0``, ``V1``, ``V2``
   ...
   **説明 :**
   ...
   ``V``\ と\ ``V0``\ 等の両方が指定された場合には\ HPhi++\ を終了します。
...
*  ``J2'x``, ``J2'y``, ``J2'z``, ``J2'xy``, ``J2'yx``, ``J2'xz``, ``J2'zx``,
   ...
   **説明 :**
   ...
   ``J'``\ を指定した上で\ ``J'x, J'y, J'z``\ も指定した場合は\ HPhi++\ を終了します。
