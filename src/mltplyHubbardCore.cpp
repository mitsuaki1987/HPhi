...
void mltply::Hubbard::GC::CisAjt(
  ...
  *tmp_off = 0;
  ...
  if (ibit_tmp_1 == 0 && ibit_tmp_2 != 0) {
    ...
    *tmp_off = list_1_off;
    dmv = (std::complex<double>)sgn * tmp_V;
    zaxpy_(&nstate, &dmv, &tmp_v1[j][0], &one, &tmp_v0[list_1_off][0], &one);
  }
  else {
    return;
  }
...
void mltply::Hubbard::C::CisAisCjtAku_element(
  ...
  std::complex<double> dmv;
  int one = 1;
  tmp_sgn = X_CisAjt(list_1[j], isite3, isite4, Bsum, Bdiff, tmp_off, list_2_1, list_2_2);
  if (tmp_sgn != 0) {
...
void mltply::Hubbard::C::CisAjtCkuAku_element(
  ...
  tmp_sgn = X_CisAis(list_1[j], isite3);
  if (tmp_sgn != 0) {
    tmp_sgn *= X_CisAjt(list_1[j], isite1, isite2, Asum, Adiff, tmp_off, list_2_1, list_2_2);
    if (tmp_sgn != 0) {
      dmv = tmp_V * (std::complex<double>)tmp_sgn;
      zaxpy_(&nstate, &dmv, &tmp_v1[j][0], &one, &tmp_v0[*tmp_off][0], &one);
    }
...
void mltply::Hubbard::C::CisAjtCkuAlv_element(
  ...
  std::complex<double> dmv;
  tmp_sgn = mltply::Hubbard::GC::X_CisAjt(list_1[j], isite3, isite4, Bsum, Bdiff, &tmp_off_1);

  if (tmp_sgn != 0) {
    tmp_sgn *= X_CisAjt(tmp_off_1, isite1, isite2, Asum, Adiff, tmp_off_2,list_2_1, list_2_2);
    if (tmp_sgn != 0) {
      dmv = tmp_V * (std::complex<double>)tmp_sgn;
...
void mltply::Hubbard::GC::CisAisCisAis_element(
  ...
  std::complex<double> dmv;
  int one = 1;
  tmp_sgn = mltply::Hubbard::C::X_CisAis(j, isite3);
  tmp_sgn *= mltply::Hubbard::C::X_CisAis(j, isite1);
  if (tmp_sgn != 0) {
    dmv = tmp_V * (std::complex<double>)tmp_sgn;
    zaxpy_(&nstate, &dmv, &tmp_v1[j][0], &one, &tmp_v0[j][0], &one);
  }
...
void mltply::Hubbard::GC::CisAisCjtAku_element(
  ...
  std::complex<double> dmv;
  int one = 1;
  tmp_sgn = mltply::Hubbard::GC::X_CisAjt(j, isite3, isite4, Bsum, Bdiff, tmp_off);
  if (tmp_sgn != 0) {
...
void mltply::Hubbard::GC::CisAjtCkuAku_element(
  ...
  tmp_sgn = mltply::Hubbard::C::X_CisAis(j, isite3);
  if (tmp_sgn != 0) {
    tmp_sgn *= mltply::Hubbard::GC::X_CisAjt(j, isite1, isite2, Asum, Adiff, tmp_off);
    if (tmp_sgn != 0) {
      dmv = tmp_V * (std::complex<double>)tmp_sgn;
      zaxpy_(&nstate, &dmv, &tmp_v1[j][0], &one, &tmp_v0[*tmp_off][0], &one);
    }/*if (tmp_sgn != 0)*/
...
void mltply::Hubbard::GC::CisAjtCkuAlv_element(
  ...
  tmp_sgn = mltply::Hubbard::GC::X_CisAjt(j, isite3, isite4, Bsum, Bdiff, &tmp_off_1);
  if (tmp_sgn != 0) {
...
int mltply::Hubbard::C::X_Cis(
  ...
  long int *tmp_off,//!<[out] Index of final wavefunction
  long int *list_1,//!<[in] 
  long int *list_2_1,//!<[in]
  long int *list_2_2//!<[in]
) {
  long int list_1_j, list_1_off;
  long int ibit_tmp_1;
  long int bit;
  ...
  *tmp_off = 0;
  ...
  if (ibit_tmp_1 == 0) {
    ...
    if(GetOffComp(list_2_1, list_2_2, list_1_off, 
