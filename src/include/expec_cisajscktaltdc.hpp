...
std::complex<double> child_Cor_1(long unsigned int j,
...
std::complex<double> child_Cor_2(long unsigned int j,
...
std::complex<double> child_Cor_3(long unsigned int j,
                   long unsigned int is_A,
                   long unsigned int is_B,
                   long unsigned int is1,
                   long unsigned int is2,
