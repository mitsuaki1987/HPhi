  ...
  for (kCell = 0; kCell < StdI::NCell; kCell++) {
    ...
    */
    ...
    if (strcmp(StdI::model, "spin") == 0 ) {
      ...
      StdFace_MagField(StdI::S2, -StdI::h, -StdI::Gamma, isite + 1);
      StdFace_GeneralJ(StdI::D, StdI::S2, StdI::S2, isite, isite);
      StdFace_GeneralJ(StdI::D, StdI::S2, StdI::S2, isite + 1, isite + 1);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_HubbardLocal(StdI::mu, -StdI::h, -StdI::Gamma, StdI::U, isite);
      StdFace_HubbardLocal(StdI::mu, -StdI::h, -StdI::Gamma, StdI::U, isite + 1);
      /**/
      if (strcmp(StdI::model, "kondo") == 0 ) {
        jsite = StdI::NsiteUC * kCell;
        StdFace_GeneralJ(StdI::J, 1, StdI::S2, isite, jsite);
        StdFace_GeneralJ(StdI::J, 1, StdI::S2, isite + 1, jsite + 1);
        StdFace_MagField(StdI::S2, -StdI::h, -StdI::Gamma, jsite);
        StdFace_MagField(StdI::S2, -StdI::h, -StdI::Gamma, jsite + 1);
      }/*if (strcmp(StdI::model, "kondo") == 0 )*/
    }
    /*
    Nearest neighbor intra cell 0 -> 1
    */
    StdFace_SetLabel(fp, iW, iL, 0, 0, 0, 1, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J0, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t0, isite, jsite, dR);
      StdFace_Coulomb(StdI::V0, isite, jsite);
    }
    /*
    Nearest neighbor along W 1 -> 0
    */
    StdFace_SetLabel(fp, iW, iL, 1, 0, 1, 0, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J1, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t1, isite, jsite, dR);
      StdFace_Coulomb(StdI::V1, isite, jsite);
    }
    /*
    Nearest neighbor along L 1 -> 0
    */
    StdFace_SetLabel(fp, iW, iL, 0, 1, 1, 0, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J2, StdI::S2, StdI::S2, isite, jsite);
    }
    else {
      StdFace_Hopping(Cphase * StdI::t2, isite, jsite, dR);
      StdFace_Coulomb(StdI::V2, isite, jsite);
    }
    /*
    Second nearest neighbor along W 0 -> 0
    */
    StdFace_SetLabel(fp, iW, iL, 1, 0, 0, 0, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J2p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t2p, isite, jsite, dR);
      StdFace_Coulomb(StdI::V2p, isite, jsite);
    }
    /*
    Second nearest neighbor along W 1 -> 1
    */
    StdFace_SetLabel(fp, iW, iL, 1, 0, 1, 1, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J2p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 0, 1, 0, 0, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J1p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t1p, isite, jsite, dR);
      StdFace_Coulomb(StdI::V1p, isite, jsite);
    }
    /*
    Second nearest neighbor along L 1 -> 1
    */
    StdFace_SetLabel(fp, iW, iL, 0, 1, 1, 1, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J1p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 1, - 1, 0, 0, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J0p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t0p, isite, jsite, dR);
      StdFace_Coulomb(StdI::V0p, isite, jsite);
    }
    /*
    Second nearest neighbor along W - L 1 -> 1
    */
    StdFace_SetLabel(fp, iW, iL, 1, -1, 1, 1, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI::J0p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 1, -1, 0, 1, &isite, &jsite, 3, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J1pp, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t1pp, isite, jsite, dR);
      StdFace_Coulomb(StdI::V1pp, isite, jsite);
    }
    /*
    Third nearest neighbor along - W - L 0 -> 1
    */
    ...
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J0pp, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t0pp, isite, jsite, dR);
      StdFace_Coulomb(StdI::V0pp, isite, jsite);
    }
    /*
    Third nearest neighbor along - W + L 0 -> 1
    */
    ...
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J2pp, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    else {
      StdFace_Hopping(Cphase * StdI::t2pp, isite, jsite, dR);
      StdFace_Coulomb(StdI::V2pp, isite, jsite);
    }
  }/*for (kCell = 0; kCell < StdI::NCell; kCell++)*/
