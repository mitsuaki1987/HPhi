...
void StdFace_Triangular()
{
  ...
  */
  for (kCell = 0; kCell < StdI::NCell; kCell++) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 1, 0, 0, 0, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 0, 1, 0, 0, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 1, - 1, 0, 0, &isite, &jsite, 1, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 2, - 1, 0, 0, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
     ...
     */
    StdFace_SetLabel(fp, iW, iL, - 1, 2, 0, 0, &isite, &jsite, 2, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 2, 0, 0, 0, &isite, &jsite, 3, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 0, 2, 0, 0, &isite, &jsite, 3, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_SetLabel(fp, iW, iL, 2, -2, 0, 0, &isite, &jsite, 3, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
