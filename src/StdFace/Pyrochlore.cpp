...
void StdFace_Pyrochlore()
{
  ...
  */
  for (kCell = 0; kCell < StdI::NCell; kCell++){
    ...
    */
    ...
    if (strcmp(StdI::model, "spin") == 0) {
      ...
      if (strcmp(StdI::model, "kondo") == 0) {
        ...
        for (isiteUC = 0; isiteUC < StdI::NsiteUC; isiteUC++) {
          StdFace_GeneralJ(StdI::J, 1, StdI::S2, isite + 3, jsite + isiteUC);
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 0, 1, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0 ) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 0, 2, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 0, 3, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 2, 3, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 3, 1, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 0, 1, 2, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
    ...
    */
    StdFace_FindSite(iW, iL, iH, 1, 0, 0, 1, 0, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J0, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 1, 0, 2, 0, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J1, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, 0, 1, 3, 0, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J2, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_FindSite(iW, iL, iH, 0, -1, 1, 3, 2, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J0p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_FindSite(iW, iL, iH, 1, 0, -1, 1, 3, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J1p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
    ...
    */
    StdFace_FindSite(iW, iL, iH, -1, 1, 0, 2, 1, &isite, &jsite, &Cphase, dR);
    /**/
    if (strcmp(StdI::model, "spin") == 0) {
      StdFace_GeneralJ(StdI::J2p, StdI::S2, StdI::S2, isite, jsite);
    }/*if (strcmp(StdI::model, "spin") == 0 )*/
