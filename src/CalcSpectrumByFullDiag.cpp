...
)
{
  ...
  */
  ...
  for (idims = 0; idims < Check::idim_maxs; idims++) Wave::v1[idims][idims] = 1.0;
  mltply::main(Check::idim_maxs, Wave::v0, Wave::v1, Check::idim_maxs,
